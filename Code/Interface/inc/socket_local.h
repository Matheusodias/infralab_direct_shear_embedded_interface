...
#define machine_payload_size 8 * sizeof(uint32_t) /*!< Tamanho do payload da mensagem enviada pela máquina.*/
        ...
        */
        ...
        union {
            ...
            struct {
                ...
                uint16_t velocity;/*!< Velocidade que a máquina terá na fase de cisalhamento. */
            };
            struct {
